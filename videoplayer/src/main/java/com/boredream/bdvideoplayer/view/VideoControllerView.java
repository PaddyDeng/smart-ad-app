...
//        rate.setOnClickListener(mRateClick);
        close_btn.setOnClickListener(mCloseClick);
    ...
    //修改倍率
    private OnClickListener mRateClick =new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private OnClickListener mCloseClick =new OnClickListener() {
        ...
        public void onClick(View v) {
            if (onVideoControlListener != null) {
//                onVideoControlListener.onClose();
                onVideoControlListener.showAndHide();
            }
        }
    };
    ...
    void toggleVideoLayoutParams() {
        final boolean isPortrait = DisplayUtils.isPortrait(getContext());//竖频

        if (isPortrait) {
            mControllerBack.setVisibility(VISIBLE);
            mVideoFullScreen.setVisibility(View.VISIBLE);
            mScreenLock.setVisibility(GONE);
            close_btn.setVisibility(GONE);
//            rate.setVisibility(GONE);
        } else {
            mVideoFullScreen.setVisibility(View.GONE);
            close_btn.setVisibility(VISIBLE);
