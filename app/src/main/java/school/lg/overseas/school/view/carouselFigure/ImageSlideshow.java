package school.lg.overseas.school.view.carouselFigure;
...
//            TextView tvTitle = (TextView) view.findViewById(R.id.tv_title);
            if (i == 0) {// 将最前面一页设置成本来最后的那页
                new GlideUtils().load(context,imageTitleBeanList.get(count - 1).getImageUrl(),ivImage);
//                tvTitle.setText(imageTitleBeanList.get(count - 1).getTitle());
            } else if (i == count + 1) {// 将最后面一页设置成本来最前的那页
                new GlideUtils().load(context,imageTitleBeanList.get(0).getImageUrl(),ivImage);
//                tvTitle.setText(imageTitleBeanList.get(0).getTitle());
            } else {
                new GlideUtils().load(context,imageTitleBeanList.get(i - 1).getImageUrl(),ivImage);
