...
public class HotQuestionAdapter extends RecyclerView.Adapter<HotQuestionAdapter.ViewHolder>{
    ...
    public HotQuestionAdapter(Context context, List<QuestionData> datas) {
        this.context=context;
        this.datas=datas;
    }

    @Override
    public HotQuestionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(HotQuestionAdapter.ViewHolder holder, int position) {
        ...
        holder.answer_num.setText(data.getAnswer().size()+"");
