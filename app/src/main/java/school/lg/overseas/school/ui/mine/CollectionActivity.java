...
//            @Override
//            public void onClick(View v) {
//                LatelyDeleteAllDialog dialog =new LatelyDeleteAllDialog(CollectionActivity.this,R.style.AlphaDialogAct);
...
//        });
    ...
    public void initView() {
        ...
        LinearLayoutManager titleManager =new LinearLayoutManager(CollectionActivity.this,LinearLayoutManager.HORIZONTAL,false);
        title_list.setLayoutManager(titleManager);
        final TitleAdapter titleAdapter =new TitleAdapter(CollectionActivity.this, titles, new SelectListener() {
            @Override
        ...
        for (int i = 0; i < titles.size(); i++) {
            List<Reading> readings = PracticeManager.getInstance().queryForType(1, i);
            View v = LayoutInflater.from(CollectionActivity.this).inflate(R.layout.fragment_recycler,null);
            ...
            LatelyAdapter adapter = new LatelyAdapter(CollectionActivity.this, readings);
