...
public class HotCaseAdapter extends RecyclerView.Adapter<HotCaseAdapter.ViewHolder>{
    private Context context;
    private List<LittleData> datas;
    public HotCaseAdapter(Context context, List<LittleData> datas) {
        this.context=context;
        this.datas=datas;
    }

    @Override
    public HotCaseAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(HotCaseAdapter.ViewHolder holder, int position) {
