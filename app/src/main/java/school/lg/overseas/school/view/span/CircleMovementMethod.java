...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.praise_item_selector_default;
    /**
     * 整个textView的背景色
     */
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = MyApplication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MyApplication.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
